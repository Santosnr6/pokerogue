...
namespace PokeRogue.Domain.Services
{
    public static class TypeEffectivenessService
    {
        ...
        private static double GetSingleTypeMultiplier(
            PokemonType attackType,
        ...
        )
        {
            ...
            {
                // PokeRogue does not use complete type immunities.
                // Matchups that would normally have a 0x multiplier use 0.25x instead.
                // This prevents battles from becoming unwinnable since each Pokémon
                // only has one available attack.

                // NORMAL
                (PokemonType.Normal, PokemonType.Rock) => 0.5,
                (PokemonType.Normal, PokemonType.Ghost) => 0.25,
                ...
                (PokemonType.Electric, PokemonType.Ground) => 0.25,
                ...
                (PokemonType.Fighting, PokemonType.Ghost) => 0.25,
                ...
                (PokemonType.Ground, PokemonType.Flying) => 0.25,
                ...
                (PokemonType.Ghost, PokemonType.Normal) => 0.25,

                // DRAGON
                (PokemonType.Dragon, PokemonType.Dragon) => 2.0,

                // Everything not explicitly listed is neutral
                _ => 1.0
            };
        }
    }
